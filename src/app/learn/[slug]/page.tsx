...
export default async function PostPage({ params }: Props) {
  ...
  const transform = (domNode: DOMNode) => {
    if (domNode.type === 'tag' && domNode.name === 'img' && domNode.attribs) {
      ...
      // Calculate aspect ratio from WordPress dimensions
...
//                 {/* Continue Reading Section - Right Column */}
//                 <div className="group block rounded-lg bg-gray-50 p-6 transition-colors hover:bg-gray-100">
//                   <h2 className="mb-6 text-2xl font-semibold text-gray-900">
//                     Continue Reading
//                   </h2>
...
// //             {/* Enhanced Article Footer with Author Bio */}
// //             <footer className="not-prose pt-12">
// //               <div className="mb-8">
// //                 <h2 className="mb-6 text-2xl font-semibold text-gray-900">
// //                   About the Author
// //                 </h2>
