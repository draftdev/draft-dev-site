      ...
      {NAVIGATION_CONFIG.links.map(({ href, label }) =>
        label === 'Why Us?' ? (
          <WhyUsPopover
            ...
            onToggle={() => {
              setIsWhyUsOpen((v) => !v)
              setIsServicesOpen(false) // Close Services when opening Why Us
            }}
          ...
          <ServicesPopover
            ...
            onToggle={() => {
              ...
              setIsWhyUsOpen(false) // Close Why Us when opening Services
            }}
...
//   // Close popover on route changes
//   useEffect(() => {
//     setIsWhyUsOpen(false)
//   }, [pathname])
