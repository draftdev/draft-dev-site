  ...
  const WhyUsPopover = memo(() => (
    <div className="relative">
      ...
      {isWhyUsOpen && (
        <div
          id="why-us-popover"
          className="fixed inset-x-0 z-50 mx-auto max-h-[calc(100vh-9rem)] w-[95vw] max-w-4xl overflow-y-auto rounded-xl bg-white shadow-lg ring-1 ring-black/5 lg:w-[85vw]"
          style={{ top: '8rem' }}
        >
