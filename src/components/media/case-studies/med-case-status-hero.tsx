      ...
      <main className="relative isolate my-32">
        <div className="mx-auto max-w-7xl p-6 lg:px-8">
          <div className="mx-auto max-w-xl gap-x-12 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="relative w-full lg:max-w-xl lg:shrink-0">
              ...
              <div className="mt-6 flex flex-col items-center gap-x-6 sm:mt-16 sm:flex-row">
                <Link
                  ...
                  className="text-gradient-brand ring-gradient-1 hover:bg-gradient-brand focus-visible:outline-primary my-2 rounded-sm bg-transparent px-3.5 py-2.5 text-sm font-semibold text-gray-700 shadow-sm ring-2 hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 sm:my-0 sm:text-base"
                >
            ...
            <div className="m-auto lg:w-[400px]">
