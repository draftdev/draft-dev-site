          ...
          <div className="px-6 lg:px-0 lg:pr-4">
            <div className="mx-auto max-w-3xl sm:max-w-4xl lg:mx-0">
              ...
              {(subtitleBold || subtitleRegular) && (
                <h3 className="lg:paragraph-dark py-4 text-gray-600 sm:text-lg">
                  {subtitleBold && (
                    <span className="lg:lead-dark font-semibold text-gray-600 sm:text-lg">
                      {subtitleBold}
                      {subtitleRegular && ' '}
                    </span>
                  )}
              ...
              <dl className="mt-6 max-w-xl space-y-8 text-lg/7 text-gray-600 lg:max-w-none">
                {steps.map((step, index) => (
                  <div key={index} className="relative">
                    <dt className="text-secondary text-base font-bold lg:text-lg">
